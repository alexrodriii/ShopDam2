...
// create shop
		...
		btnExportProduct = new JButton("0. Exportar inventario");

		btnExportProduct.setHorizontalAlignment(SwingConstants.LEFT);

		btnExportProduct.addActionListener(new ActionListener() {

			public void actionPerformed(ActionEvent e) {

				if (e.getSource() == btnExportProduct) {
					boolean exportar = shop.writeInventory();
					   if (exportar) {
				         
				       JOptionPane.showMessageDialog(null, "Inventario exportado", "Confirmado", JOptionPane.INFORMATION_MESSAGE);
				        } else {
		...
		btnExportProduct.setBounds(103, 40, 141, 43);

		contentPane.add(btnExportProduct);
// option count cash
...
// option add product
		...
		btnAddProduct.setBounds(99, 130, 236, 40);
...
// option add stock
		...
		btnAddStock.setBounds(99, 170, 236, 40);
